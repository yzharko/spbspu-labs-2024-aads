...
namespace mihalchenko
{
  ...
  bool compareElemByFreq(const dictElement_t &iterOfElem1, const dictElement_t &iterOfElem2);
  bool compareElemByAlph(const dictElement_t &iterOfElem1, const dictElement_t &iterOfElem2);
