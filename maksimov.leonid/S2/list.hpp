...
template< typename T >
maksimov::List< T >::ConstIterator::ConstIterator(Unit* ptr) :
  unit(ptr)
{}
...
template< typename T >
typename maksimov::List< T >::ConstIterator maksimov::List< T >::ConstIterator::operator+(size_t index)
{
...
template< typename T >
maksimov::List< T >::Iterator::Iterator(Unit* ptr) :
  iter_(ConstIterator(ptr))
{}

template< typename T >
maksimov::List< T >::Iterator::Iterator(ConstIterator constIter) :
  iter_(constIter)
{}
...
template< typename T >
T& maksimov::List< T >::operator[](const size_t index)
{
  size_t counter = 0;
...
template< typename T >
maksimov::List< T >::List(size_t amount)
{
  size = 0;
...
template< typename T >
maksimov::List< T >::List(size_t amount, const T& data)
{
  size = 0;
...
template< typename T >
maksimov::List< T >::List(iter beginThat, iter endThat)
{
  size = 0;
...
template<typename T>
maksimov::List<T>::List(std::initializer_list<T> ilThat)
{
  size = 0;
  for (T data : ilThat)
  {
...
template< typename T >
void maksimov::List< T >::pushFront(T& data)
{
...
template< typename T >
void maksimov::List< T >::pushBack(const T& data)
{
  if (head == nullptr)
  {
    head = new Unit(data);
...
template<typename T>
void maksimov::List<T>::assign(size_t amount, T& data)
{
  clear();
  for (int i = 0; i < amount; i++)
  {
...
template<typename T>
void maksimov::List<T>::assign(iter beginThat, iter endThat)
{
  clear();
  while (beginThat != endThat)
  {
...
template<typename T>
void maksimov::List<T>::assign(std::initializer_list<T> ilThat)
{
  clear();
  for (T data : ilThat)
  {
...
template<typename T>
typename maksimov::List< T >::Iterator maksimov::List<T>::insert(iter pos, iter beginThat, iter endThat)
{
  while (beginThat != endThat)
  {
...
template<typename T>
typename maksimov::List< T >::Iterator maksimov::List<T>::insert(iter& pos, T& data)
{
  if (pos == begin())
  {
    pushFront(data);
...
template<typename T>
typename maksimov::List< T >::Iterator maksimov::List<T>::insert(iter& pos, size_t& amount, T& data)
{
  if (amount == 0)
  {
    return pos;
...
template<typename T>
typename maksimov::List< T >::Iterator maksimov::List<T>::erase(iter& pos)
{
...
template<typename T>
typename maksimov::List< T >::Iterator maksimov::List<T>::erase(iter& first, iter& last)
{
  if (first == last)
  {
    return(last);
...
template< typename T >
void maksimov::List< T >::remove(const T& value)
{
  iter it = begin();
  while (it != end())
  {
...
template< typename T >
template< class Func >
void maksimov::List< T >::remove_if(Func p)
{
  iter it = begin();
  while (it != end())
  {
...
template< typename T >
T& maksimov::List< T >::getBack() const
{
  return tail->data;
}

template< typename T >
void maksimov::List< T >::swap(List< T >& targetList) noexcept
{
...
template< typename T >
void maksimov::List< T >::splice(iter pos, List< T >& other)
{
  if (!(other.empty()))
  {
...
template< typename T >
bool maksimov::List< T >::empty() const noexcept
{
