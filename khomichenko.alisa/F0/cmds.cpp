...
void khomichenko::addDictionary(std::istream& in, Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
  std::string name = "";
  in >> name;
...
void khomichenko::deleteDictionary(std::istream& in,
...
void khomichenko::addWord(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
  std::string name = "";
  in >> name;
...
void khomichenko::removeWord(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
  std::string name = "";
  in >> name;
...
void khomichenko::translate(std::ostream& out,
    std::istream& in,
...
void khomichenko::mergeDictionaries(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
...
void khomichenko::getIntersection(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
...
void khomichenko::getCombining(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
  std::string new_dict_name, first_name, second_name;
  in >> new_dict_name >> first_name >> second_name;
...
void khomichenko::getDifference(std::istream& in,
    Tree< std::string, Tree< std::string, List< std::string > > >& dictionaries)
{
