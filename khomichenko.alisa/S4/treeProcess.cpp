...
void khomichenko::readData(std::istream& in, Tree< std::string, Tree< size_t, std::string > >& allTree)
{
  while(!in.eof())
  {
...
void khomichenko::createTree(Tree< std::string, Tree< size_t, std::string > >& allTree, std::string dictionary)
{
  std::string temp = "";
  std::string name = "";
  size_t key = 0;
...
void khomichenko::print(Tree< std::string, Tree< size_t, std::string > >& allTree)
{
  std::string dictionary;
  std::cin >> dictionary;
...
void khomichenko::getComplement(Tree< std::string, Tree< size_t, std::string > >& allTree)
{
  std::string name;
...
void khomichenko::getIntersect(Tree< std::string, Tree< size_t, std::string > >& allTree)
{
  std::string name;
  std::string  nameFirst;
  std::string  nameSecond;
...
void khomichenko::getUnion(Tree< std::string, Tree< size_t, std::string > >& allTree)
{
  std::string name;
  std::string  nameFirst;
  std::string  nameSecond;
