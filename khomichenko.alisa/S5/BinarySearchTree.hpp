...
class khomichenko::Tree< Key, Value, Compare >::Node
{
public:
...
template< typename Key, typename Value, typename Compare >
khomichenko::Tree< Key, Value, Compare >::Node::Node(Key key, Value value, Node* father, Node* left, Node* right):
  left_(left),
  right_(right),
  father_(father),
...
template< typename Key, typename Value, typename Compare >
class khomichenko::Tree< Key, Value, Compare >::Iterator : public std::iterator< std::bidirectional_iterator_tag, Pair >
{
public:
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator::this_t& khomichenko::Tree< Key, Value, Compare >::Iterator::operator++()
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator::this_t khomichenko::Tree< Key, Value, Compare >::Iterator::operator++(int)
{
  assert(node_ != nullptr);
...
template< typename Key, typename Value, typename Compare >
bool khomichenko::Tree< Key, Value, Compare >::Iterator::operator==(const this_t& other) const
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Pair& khomichenko::Tree< Key, Value, Compare >::Iterator::operator*() const
{
  assert(node_ != nullptr);
...
template< typename Key, typename Value, typename Compare >
class khomichenko::Tree< Key, Value, Compare >::ConstIterator : public std::iterator< std::bidirectional_iterator_tag, Pair >
{
public:
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::ConstIterator& khomichenko::Tree< Key, Value, Compare >::ConstIterator::operator++()
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::ConstIterator khomichenko::Tree< Key, Value, Compare >::ConstIterator::operator++(int)
{
  assert(iterator_.node_ != nullptr);
  ++iterator_;
  return *this;
...
template< typename Key, typename Value, typename Compare >
bool khomichenko::Tree< Key, Value, Compare >::ConstIterator::operator==(const this_t& other) const
{
...
template< typename Key, typename Value, typename Compare >
const typename khomichenko::Tree< Key, Value, Compare >::Pair& khomichenko::Tree< Key, Value, Compare >::ConstIterator::operator*() const
{
  assert(iterator_.node_ != nullptr);
...
template< typename Key, typename Value, typename Compare >
khomichenko::Tree< Key, Value, Compare >::Tree():
  root_(nullptr),
  comp(Compare())
{};

template< typename Key, typename Value, typename Compare >
khomichenko::Tree< Key, Value, Compare >::Tree(const Tree& tree)
{
  root_ = nullptr;
  comp = tree.comp;
...
template< typename Key, typename Value, typename Compare >
khomichenko::Tree< Key, Value, Compare >::Tree(Tree&& tree):
  root_(tree.root_),
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator khomichenko::Tree< Key, Value, Compare >::end() const noexcept
{
  Node* current = root_;
  if(current == nullptr)
  {
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator khomichenko::Tree< Key, Value, Compare >::begin() const noexcept
{
  Node* current = root_;
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::ConstIterator khomichenko::Tree< Key, Value, Compare >::cend() const noexcept
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::ConstIterator khomichenko::Tree< Key, Value, Compare >::cbegin() const noexcept
{
...
template< typename Key, typename Value, typename Compare >
bool khomichenko::Tree< Key, Value, Compare >::isEmpty() const noexcept
{
  return (root_ == nullptr) ? true : false;
}

template< typename Key, typename Value, typename Compare >
size_t khomichenko::Tree< Key, Value, Compare >::getSize() const noexcept
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator khomichenko::Tree< Key, Value, Compare >::find(const Key& key) const
{
  Node* current = root_;
  while(current != nullptr)
  {
...
template< typename Key, typename Value, typename Compare >
size_t khomichenko::Tree< Key, Value, Compare >::count(const Key& key) const
{
  if(find(key) == end())
  {
    return 0;
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Range khomichenko::Tree< Key, Value, Compare >::getEqualRange(const Key& key) const
{
  if(find(key) != begin())
  {
...
template< typename Key, typename Value, typename Compare >
size_t khomichenko::Tree< Key, Value, Compare >::getHeight(Node* node)
{
  if(node == nullptr)
  {
    return 0;
...
template< typename Key, typename Value, typename Compare >
long long khomichenko::Tree< Key, Value, Compare >::getDifference(Node* node)
{
  return getHeight(node -> left_) - getHeight(node -> right_);
}

template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::RightRight(Node* node)
{
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::LeftLeft(Node* node)
{
  Node* bigFather = node -> father_;
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Node* khomichenko::Tree< Key, Value, Compare >::checkBalance(Node* node)
{
  while(node != nullptr)
  {
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::balance(Node* node)
{
  Node* toBalance = node;
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::insert(const Key& key, const Value& value)
{
  if(find(key) != end())
  {
    erase(key);
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::insert(Pair& pair)
{
  insert(pair.first, pair.second);
}

template< typename Key, typename Value, typename Compare >
Value& khomichenko::Tree< Key, Value, Compare >::operator[](const Key& key)
{
  if(find(key) == end())
  {
    insert(key, Value());
...
template< typename Key, typename Value, typename Compare >
Value& khomichenko::Tree< Key, Value, Compare >::at(const Key& key)
{
  if(find(key) == end())
  {
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::clear(Node* node)
{
  if(node != nullptr)
  {
    clear(node -> left_);
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::clear()
{
  if(!isEmpty())
  {
    clear(root_);
...
template< typename Key, typename Value, typename Compare >
void khomichenko::Tree< Key, Value, Compare >::swap(Tree& other)
{
...
template< typename Key, typename Value, typename Compare >
typename khomichenko::Tree< Key, Value, Compare >::Iterator khomichenko::Tree< Key, Value, Compare >::erase(Iterator iterator)
{
...
template< typename Key, typename Value, typename Compare >
size_t khomichenko::Tree< Key, Value, Compare >::erase(const Key& key)
{
...
template< typename Key, typename Value, typename Compare >
template< typename F >
F khomichenko::Tree< Key, Value, Compare >::traverse_lnr(F f) const
{
  Stack < Node* > stack;
  Node* current = root_;
...
template< typename Key, typename Value, typename Compare >
template< typename F >
F khomichenko::Tree< Key, Value, Compare >::traverse_rnl(F f) const
{
  Stack< Node* > stack;
  Node* current = root_;
  while(current != nullptr || !stack.isEmpty())
...
template< typename Key, typename Value, typename Compare >
template< typename F >
F khomichenko::Tree< Key, Value, Compare >::traverse_breadth(F f) const
{
  if(!isEmpty())
  {
    Queue< Node* > queue;
