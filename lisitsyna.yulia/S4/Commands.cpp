...
void lisitsyna::complement(data_t& data, std::istream& input)
{
  std::string new_name;
...
void lisitsyna::intersect(data_t& data, std::istream& input)
{
  std::string new_name;
  std::string first_name;
  std::string second_name;
...
void lisitsyna::uniond(data_t& data, std::istream& input)
{
  std::string new_name;
  std::string first_name;
  std::string second_name;
