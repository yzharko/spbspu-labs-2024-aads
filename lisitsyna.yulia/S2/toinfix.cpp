...
void lisitsyna::input_infix(std::istream& input, Queue< Queue< std::string > >& input_queue)
{
  std::string line;
...
void lisitsyna::to_postfix(Queue< std::string >& process_queue, Queue< std::string >& result_queue)
{
