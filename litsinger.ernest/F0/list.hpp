...
template< typename T >
litsinger::List< T >::ConstIterator::ConstIterator(Node* pNode)
{
  this->pNode = pNode;
}
...
template< typename T >
bool litsinger::List< T >::ConstIterator::operator!=(const this_t& lhs) const
{
  return !(*this == lhs);
}
...
template< typename T >
litsinger::List< T >::Iterator::Iterator(ConstIterator constIterator)
{
...
template< typename T >
const T& litsinger::List< T >::Iterator::operator*() const
{
  return iter_.pNode->data;
}
...
template< typename T >
bool litsinger::List< T >::Iterator::operator!=(const this_t& lhs) const
{
...
template< typename T >
litsinger::List< T >::List(size_t count)
{
...
template< typename T >
litsinger::List< T >::List(size_t count, const T& value)
{
  for (size_t i = 0; i < count; i++)
  {
    push_back(value);
...
template< typename T >
litsinger::List< T >::List(Iterator begin, Iterator end, int value)
{
...
template< typename T >
litsinger::List< T >::List(const litsinger::List< T >& other)
{
...
template< typename T >
litsinger::List< T >::List(std::initializer_list< T > ilist)
{
  assign(ilist);
}
...
template< typename T >
void litsinger::List< T >::assign(size_t count, const T& value)
{
  clear();
  for (size_t i = 0; i < count; i++)
  {
...
template< typename T >
void litsinger::List< T >::assign(Iterator first, Iterator last)
{
  clear();
  while (first != last)
  {
...
template< typename T >
void litsinger::List< T >::assign(std::initializer_list< T > ilist)
{
  clear();
...
template< typename T >
bool litsinger::List< T >::is_empty() noexcept
{
...
template< typename T >
void litsinger::List< T >::push_front(const T& data)
{
...
template< typename T >
void litsinger::List< T >::push_back(const T& data)
{
  Node* nData = new Node(data);
  if (head == nullptr)
  {
...
template< typename T >
void litsinger::List< T >::pop_front()
{
  if (is_empty())
  {
    throw std::logic_error("Empty list!");
...
template< typename T >
void litsinger::List< T >::pop_back()
{
  if (is_empty())
  {
    throw std::logic_error("Empty list!");
...
template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::insert(Iterator pos, const T& value)
{
...
template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::insert(Iterator pos, size_t count, const T& value)
{
  Iterator newPos = begin();
  for (size_t i = 0; i < count; i++)
  {
...
template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::erase(Iterator pos)
{
  Iterator newPos = begin();
  if (pos == end())
  {
...
template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::erase(Iterator first, Iterator last)
{
  Iterator newPos = begin();
  if (first == last)
  {
...
template< typename T >
void litsinger::List< T >::splice(Iterator pos, List< T >& other)
{
  if (other.is_empty())
  {
    throw std::logic_error("Empty list!");
...
template< typename T >
void litsinger::List< T >::swap(List< T >& other) noexcept
{
...
template< typename T >
void litsinger::List< T >::remove(T value)
{
  size_t count = 0;
  Node* actual = head;
  Node* todel = head;
...
template< typename T >
template< class UnaryPredicate >
void litsinger::List< T >::remove_if(UnaryPredicate p)
{
  Node* actial = head;
  Node* before_actial = head;
  while (actial)
...
template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::begin() noexcept
{
  return Iterator(head);
}

template< typename T >
typename litsinger::List< T >::Iterator litsinger::List< T >::end() noexcept
{
  return Iterator(nullptr);
}

template< typename T >
typename litsinger::List< T >::ConstIterator litsinger::List< T >::begin() const noexcept
{
  return ConstIterator(head);
}

template< typename T >
typename litsinger::List< T >::ConstIterator litsinger::List< T >::end() const noexcept
{
  return ConstIterator(nullptr);
}

template< typename T >
typename litsinger::List< T >::ConstIterator litsinger::List< T >::cbegin() const noexcept
{
  return ConstIterator(head);
}

template< typename T >
typename litsinger::List< T >::ConstIterator litsinger::List< T >::cend() const noexcept
{
  return ConstIterator(nullptr);
}

template< typename T >
void litsinger::List< T >::advance(Iterator& pos, size_t count)
{
  if (count < 0)
  {
...
template< typename T >
void litsinger::List<T>::advance(Iterator& first, Iterator last)
{
