...
void malanin::getGraphsNames(const Workspace& workspace, List< std::string >& accumulator)
{
...
void malanin::readGraph(const std::string& filename, Graph& container)
{
