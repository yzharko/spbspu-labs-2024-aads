...
std::ostream& malanin::commands::node(std::ostream& out, std::istream& in, Workspace& workspace)
{
  std::string action = "";
  int node = -1;
  in >> action >> node;
...
std::ostream& malanin::commands::edge(std::ostream& out, std::istream& in, Workspace& workspace)
{
  std::string action;
  int lnode, rnode;
...
void makeCastling(std::ostream&, std::string nameOfNew, malanin::Workspace& workspace)
{
...
std::ostream& malanin::commands::graph(std::ostream& out, std::istream& in, Workspace& workspace)
{
  std::string arg = "";
  in >> arg;
  if (arg == "add")
...
std::ostream& malanin::commands::list(std::ostream& out, std::istream&, const Workspace& workspace)
{
...
std::ostream& malanin::commands::jump(std::ostream& out, std::istream& in, Workspace& workspace)
{
  std::string name = "";
...
std::ostream& malanin::commands::print(std::ostream& out, std::istream& in, const Workspace& workspace)
{
  std::string arg = "";
  in >> arg;
  if (arg == "nodes")
...
std::ostream& malanin::commands::save(std::ostream& out, std::istream& in, const Workspace& workspace)
{
  std::string arg = "";
  in >> arg;
  if (arg == "-r")
...
std::ostream& malanin::commands::help(std::ostream& out, std::istream&, const Workspace&)
{
...
std::ostream& malanin::commands::quit(std::ostream& out, std::istream&, Workspace& workspace)
{
