...
namespace malanin
{
  ...
  template< typename T >
  void randCont(str type, size_t elCnt, List< T >& fList,
 std::list< T >& bList, std::deque< T >& queue);
  ...
  void merge(Iterator fbeg, Iterator fend, Iterator sbeg,
 Iterator send, OtherIter dest, Comparator cmp);

  template< typename T, typename Compare >
  void sortData(std::ostream& out, std::string type,
 size_t size, Compare cmp);
}

template< typename T >
void malanin::randCont(str type,
 size_t elCnt, List< T >&fList,
 std::list< T >&bList, std::deque< T >&queue)
{
...
template< typename T >
void malanin::printCont(std::
ostream& out, const T& container)
{
...
template< typename Iterator, typename Comparator >
void malanin::oddEvenSort(Iterator first,
 Iterator last, Comparator cmp)
{
...
template< typename Iterator, typename Comparator >
void malanin::mergeSort(Iterator first,
 Iterator last, Comparator cmp)
{
...
template< typename Iterator, typename OtherIter, typename Comparator >
void malanin::merge(Iterator fbeg, Iterator fend, Iterator sbeg,
 Iterator send, OtherIter dest, Comparator cmp)
{
...
template< typename T, typename Compare >
void malanin::sortData(std::ostream& out,
 std::string type, size_t size, Compare cmp)
{
  List< T > forwardList;
  std::list< T > list;
  std::deque< T > deque;
