...
void malanin::outputInvalidCommand(std::ostream & out)
{
  out << "<INVALID COMMAND>\n";
}

void malanin::outputEmptyError(std::ostream & out)
{
  out << "<EMPTY>\n";
}

std::string malanin::getValue(std::string & input, size_t & i)
{
  std::string result = "";
...
size_t malanin::getKey(std::string & input, size_t & i)
{
  std::string result = "";
...
void malanin::readFromFile(std::ifstream & is, Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string input;
...
void malanin::printCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string name;
  std::cin >> name;
...
void malanin::complementCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
...
void malanin::intersectCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
  std::string firstDict;
  std::string secondDict;
...
void malanin::unionCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
  std::string firstDict;
  std::string secondDict;
