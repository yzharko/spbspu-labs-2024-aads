...
class malanin::Tree< Key, Value, Comparator >::Iterator
{
public:
  Iterator();
  Iterator(Tree*);
...
template< typename Key, typename Value, typename Comparator >
malanin::Tree< Key, Value, Comparator >::Iterator::Iterator():
  cur_(nullptr),
  max_(nullptr)
{}
...
template< typename Key, typename Value, typename Comparator >
void malanin::Tree< Key, Value, Comparator >::Iterator::erase()
{
...
template< typename Key, typename Value, typename Comparator >
class malanin::Tree< Key, Value, Comparator >::ConstIterator
{
public:
...
template< typename Key, typename Value, typename Comparator >
class malanin::Tree< Key, Value, Comparator >::LnRIterator
{
public:
  LnRIterator();
...
template< typename Key, typename Value, typename Comparator >
malanin::Tree< Key, Value, Comparator >::LnRIterator::LnRIterator(Tree* ptr):
  cur_(ptr),
  temp_(nullptr),
  stack_(Stack< Tree* >())
{
...
template< typename Key, typename Value, typename Comparator >
class malanin::Tree< Key, Value, Comparator >::RnLIterator
{
public:
  RnLIterator();
...
template< typename Key, typename Value, typename Comparator >
malanin::Tree< Key, Value, Comparator >::~Tree()
{
  clear();
}
...
template< typename Key, typename Value, typename Comparator >
void malanin::Tree< Key, Value, Comparator>::swap(Tree& tree)
{
  Tree temp = tree;
  temp = *this;
  *this = temp;
...
template< typename Key, typename Value, typename Comparator >
void malanin::Tree< Key, Value, Comparator>::rotateRR()
{
...
template< typename Key, typename Value, typename Comparator >
void malanin::Tree< Key, Value, Comparator>::rotateLL()
{
