...
namespace gorbunova
{
  ...
  template <typename Key, typename Value, typename Comparator>
  template <typename F>
  F Tree<Key, Value, Comparator>::traverse_rnl(F f)
  {
    gorbunova::Stack<Node*> stack;
    Node* nodes = root_;
    if (!nodes)
    {
      return f;
  ...
  template <typename Key, typename Value, typename Comparator>
  template <typename F>
  F Tree<Key, Value, Comparator>::traverse_breadth(F f)
  {
    gorbunova::Queue<Node*> queue;
    if (root_ == nullptr)
    {
      return f;
    }
  ...
  template <typename Key, typename Value, typename Comparator>
  template <typename F>
  F Tree<Key, Value, Comparator>::traverse_lnr(F f)
  {
    Stack<Node*> stack;
    Node* nodes = root_;
    if (!nodes)
