...
void popov::outputInvalidCommand(std::ostream & out)
{
  out << "<INVALID COMMAND>\n";
}

void popov::outputEmptyError(std::ostream & out)
{
  out << "<EMPTY>\n";
}

std::string popov::getValue(std::string & input, size_t & i)
{
  std::string result = "";
...
size_t popov::getKey(std::string & input, size_t & i)
{
  std::string result = "";
...
void popov::readFromFile(std::ifstream & is, Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string input;
...
void popov::printCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string name;
  std::cin >> name;
...
void popov::complementCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
...
void popov::intersectCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
  std::string firstDict;
  std::string secondDict;
...
void popov::unionCommand(Tree< std::string, Tree< size_t, std::string > > & treeMap)
{
  std::string newDict;
  std::string firstDict;
  std::string secondDict;
