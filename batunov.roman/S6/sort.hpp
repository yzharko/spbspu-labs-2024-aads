...
template< typename T >
void batunov::randCont(str type, size_t elCnt, List< T >&fList, std::list< T >&bList, std::deque< T >&queue)
{
...
template< typename T >
void batunov::printCont(std::ostream& out, const T& container)
{
...
template< typename Iterator, typename Comparator >
void batunov::oddEvenSort(Iterator first, Iterator last, Comparator cmp)
{
...
template< typename Iterator, typename Comparator >
void batunov::mergeSort(Iterator first, Iterator last, Comparator cmp)
{
...
template< typename Iterator, typename OtherIter, typename Comparator >
void batunov::merge(Iterator fbeg, Iterator fend, Iterator sbeg, Iterator send, OtherIter dest, Comparator cmp)
{
...
template< typename T, typename Compare >
void batunov::sortData(std::ostream& out, std::string type, size_t size, Compare cmp)
{
  List< T > forwardList;
  std::list< T > list;
  std::deque< T > deque;
