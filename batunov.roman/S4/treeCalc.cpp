#include "treeCalc.hpp"
#include <functional>
#include <iostream>

void batunov::strToTree(std::string expression, BST< std::string, BST< long long, std::string > >& result)
{
  std::string symbol = "";
  size_t i = 0;
  size_t count = 0;
...
void batunov::inputTree(std::istream& input, BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void batunov::print(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void batunov::intersect(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void batunov::complement(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
  BST< long long, std::string > newDataset;
...
void batunov::unify(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
  BST< long long, std::string > newDataset;
  using tree = BST< long long, std::string >;
  std::string newDictName;
...
void batunov::warningInvCom(std::ostream& output)
{
  output << "<INVALID COMMAND>\n";
}

void batunov::warningEmpty(std::ostream& output)
{
  output << "<EMPTY>\n";
}
