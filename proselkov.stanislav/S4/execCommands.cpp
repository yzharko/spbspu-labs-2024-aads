...
void proselkov::fillTree(std::istream& in, avlTree< std::string, base_t >& dataSets)
{
  while (!in.eof())
  {
    if (in.fail())
    ...
    int key;
    in >> setName;
    proselkov::avlTree< int, std::string > curSet;
...
void proselkov::print(avlTree< std::string, avlTree< int, std::string > >& dataSets)
{
  std::string setName;
  std::cin >> setName;
...
void proselkov::complement(avlTree< std::string, avlTree< int, std::string > >& dataSets)
{
...
void proselkov::intersect(avlTree<std::string, proselkov::avlTree<int, std::string>>& dataSets)
{
  std::string newSet, fSet, sSet;
  std::cin >> newSet >> fSet >> sSet;
...
void proselkov::unio(avlTree<std::string, avlTree<int, std::string>>& dataSets)
{
  std::string newSet, fSet, sSet;
  std::cin >> newSet >> fSet >> sSet;
