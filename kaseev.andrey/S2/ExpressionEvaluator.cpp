...
void kaseev::ExpressionEvaluator::parseExpression(kaseev::Queue< std::shared_ptr< kaseev::ExpressionItem > >& qe, const std::string& ep)
{
  std::string token;
...
kaseev::Queue< std::shared_ptr< kaseev::ExpressionItem > >
kaseev::ExpressionEvaluator::toPostfix(kaseev::Queue< std::shared_ptr< kaseev::ExpressionItem > >& inQe)
{
...
long long kaseev::ExpressionEvaluator::evaluateExpression(kaseev::Queue< std::shared_ptr< kaseev::ExpressionItem > >& postfixQueue)
{
