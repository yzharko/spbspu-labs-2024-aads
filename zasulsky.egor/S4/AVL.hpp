...
public:
  ...
  node* turnLeft(node* ptr)
  {
    ...
    updateHeight(ptr);
    updateHeight(ptr->right);   // ЭТО ЗДЕСЬ !!!!!СУКА СУКА СУКА СУКА СУКА СУКА СУКА СУКА СУКА СУКА
    return pt;
  }
...
//Засулський Егор Андреевич
//Англо - русский словарь.АВЛ - дерево
//
//Команды :
//1)TRANSLATE
//Принимает словарь и слово
//выводит перевод :
//input: TRANSLATE dict1 home
//output : home - дом
//
//2)CALCULATE
//Подсчитывает количество английских слов, доступных для изучения в переданном словаре :
//input: CALCULATE dict
//output : 15
//
//3)PRINT
//выводит содержимое заданного словаря :
//input: PRINT dict
//output :
//home - дом
//car - машина
//
//4)ADD
//принимает словарь, слово вместе с переводом, которое добавляет в словарь
//Input : ADD car - машина
//
//5)HELP
//Выводит названия команд и описание их функционала;
//
//6)COMBINATION
//Принимает имя результирующего словаря и двух или более существующих, в результирующий добавляет содержимое преда
//COMBINATION res dict1 dict2
//
//7)CROSS
//принимает имя результирующего словаря и двух или более существующих.Результирующий будет содержать данные, которые
...
//output : 3
//
//9)BUILD принимает имя нового словаря и создает его
//input : BUILD new
//
//10)SEARCH
...
//
//11)TRANSLATION
//принимает словарь, слово, и новый перевод для него, добавляет новый перевод.
//input:TRANSLATION dict1 Car - машина
//
//12)TAG
//принимает словарь, список слов с переводом, добавляет все эти слова с переводами в словарь
