...
void jirkov::strToTree(std::string expression, BST< std::string, BST< long long, std::string > >& result)
{
  std::string symbol = "";
  size_t i = 0;
  size_t count = 0;
...
void jirkov::inputTree(std::istream& input, BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void jirkov::print(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void jirkov::intersect(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
...
void jirkov::complement(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
  BST< long long, std::string > newDataset;
...
void jirkov::unify(BST< std::string, BST< long long, std::string > >& treeOfDicts)
{
  BST< long long, std::string > newDataset;
  using tree = BST< long long, std::string >;
  std::string newDictName;
...
void jirkov::warningEmpty(std::ostream& output)
{
  output << "<EMPTY>\n";
}
