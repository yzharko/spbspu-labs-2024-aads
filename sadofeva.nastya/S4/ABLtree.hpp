...
template <typename Key, typename Value, typename Compare>
typename BinarySearchTree<Key, Value, Compare>::Iterator::Iterator BinarySearchTree<Key, Value, Compare>::Iterator::
operator++(int)
{
  if (nodeStack.empty())
  {
...
template <typename Key, typename Value, typename Compare>
BinarySearchTree<Key, Value, Compare>::Iterator::Iterator(Node * rootNode):
  current(nullptr)
{
  pushLeft(rootNode);
  ++(*this);
...
// inline Iterator& BinarySearchTree<Key, Value, Compare>::Iterator::operator++()
//  {
//  TODO: �������� ����� �������� return
// }
...
template <typename Key, typename Value, typename Compare>
BinarySearchTree<Key, Value, Compare>::ConstIterator::ConstIterator(const Node * rootNode):
  current(nullptr)
{
  pushLeft(rootNode);
  ++(*this);
...
template <typename Key, typename Value, typename Compare>
typename BinarySearchTree<Key, Value, Compare>::ConstIterator::ConstIterator BinarySearchTree<Key, Value, Compare>::
...
template <typename Key, typename Value, typename Compare>
typename BinarySearchTree<Key, Value, Compare>::Node * BinarySearchTree<Key, Value, Compare>::insert(Node * node,
 const Key & key,
 const Value & value)
{
  if (!node)
...
template <typename Key, typename Value, typename Compare>
typename BinarySearchTree<Key, Value, Compare>::Node * BinarySearchTree<Key, Value, Compare>::find(Node * node,
 const Key & key) const
{
  if (!node)
  {
...
template <typename Key, typename Value, typename Compare>
typename BinarySearchTree<Key, Value, Compare>::Node * BinarySearchTree<Key, Value, Compare>::remove(Node * node,
 const Key & key)
{
  if (!node)
  {
